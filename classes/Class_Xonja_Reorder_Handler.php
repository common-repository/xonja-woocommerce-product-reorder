...
class Xonja_Reorder_Handler {
    ...
    public static function init() {
        if (!Xonja_Reorder_Handler::$rh) {
            Xonja_Reorder_Handler::$rh = new Xonja_Reorder_Handler();
        }
        return Xonja_Reorder_Handler::$rh;
    }
...
add_action('init', array('Xonja_Reorder_Handler', 'init'));
